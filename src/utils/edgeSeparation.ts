 ...
 */
export function calculateEdgeOffsets(edges: Edge[], nodes: Node[]): Map<string, EdgeOffset> {
  ...
  edges.forEach((edge, index) => {
    ...
    const strokeDasharray =
      sourceTotal > 3 ? (sourceIndex % 2 === 0 ? undefined : '8 4') : undefined;
